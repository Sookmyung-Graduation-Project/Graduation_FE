                  ...
                  children: [
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              _buildDayCheckbox('월', DateTime.now().weekday == 1 && _isChecked),
                              _buildDayCheckbox('화', DateTime.now().weekday == 2 && _isChecked),
                              _buildDayCheckbox('수', DateTime.now().weekday == 3 && _isChecked),
                              _buildDayCheckbox('목', DateTime.now().weekday == 4 && _isChecked),
                              _buildDayCheckbox('금', DateTime.now().weekday == 5 && _isChecked),
                              _buildDayCheckbox('토', DateTime.now().weekday == 6 && _isChecked),
                              _buildDayCheckbox('일', DateTime.now().weekday == 7 && _isChecked),
                            ],
                          ),
                        ],
                      ),
                    ...
                    SizedBox(
                      child: Stack(
                        ...
                        children: [
                          Image.asset(
                            _isChecked ? 'assets/images/baby_dino_smile.png' : 'assets/images/baby_dino.png',
