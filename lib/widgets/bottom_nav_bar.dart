            ...
            child: Row(
              children: [
                ...
                _buildTabItem(
                  index: 1,
                  label: '서재',
                  activeIcon: 'assets/navigation_icons/library_icon_active.png',
                  inactiveIcon:
                      'assets/navigation_icons/library_icon_inactive.png',
                  screenWidth: screenWidth,
                ),
                SizedBox(width: screenWidth * 0.091),
                _buildTabItem(
                  index: 2,
                  label: '학습페이지',
                ...
                SizedBox(width: screenWidth * 0.264),
                _buildTabItem(
                  index: 3,
                  label: '책 만들기',
                  activeIcon:
                ...
                _buildTabItem(
                  index: 4,
                  label: '마이페이지',
                  activeIcon: 'assets/navigation_icons/mypage_icon_active.png',
                  inactiveIcon:
